...
export default function HomePage() {
  ...
  return (
    ...
    >
      {/* ── ANNOUNCEMENT BAR ── */}
      <div className="bg-[var(--brand-primary)] text-[var(--text-inverse)] flex items-center justify-center gap-2 sm:gap-6 flex-wrap text-center py-2 px-4 sm:px-8 text-xs sm:text-sm font-medium border-b border-white/10">
        <span>
        ...
        <span className="hidden sm:inline opacity-30">|</span>
        <BackendStatusBadge variant="compact" />
      </div>
        ...
        <section id="trending" className="py-10 sm:py-14">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-6">
              <div>
                <h2 className="text-3xl sm:text-6xl font-black text-[var(--text-primary)] tracking-tighter uppercase leading-none">
                  Trending{" "}
                  <span className="text-red-600 underline decoration-black decoration-4 underline-offset-8">
                    Now
                  </span>
